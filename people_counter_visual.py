...
# python3 people_counter_visual.py --prototxt mobilenet_ssd/MobileNetSSD_deploy.prototxt \
...
while True:
	# grab the next frame from VideoStream
	frame = vs.read()

	# resize the frame to have a maximum width of 256 pixels (the
